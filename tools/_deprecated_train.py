...
from quant_pack.deprecated import models
from quant_pack.deprecated.utils import *
...
def main():
    ...
    model = models.__dict__[CONF.arch.type](**CONF.arch.args).to(DEVICE, non_blocking=True)
    ...
    if CONF.teacher_arch is not None:
        ...
        teacher = models.__dict__[CONF.teacher_arch.type](**CONF.teacher_arch.args).to(DEVICE, non_blocking=True)
